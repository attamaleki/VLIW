...
#Testing Datamemory
for i in range(512):
    dataMemory.write(i,i);
for i in range(512):
    print(dataMemory.read(i));
...
DataMem=simulate(instructionMemory)